            ...
            <Row style={{ marginTop: '1rem' ,marginBottom: '1rem'}}>
                <Col sm={2} id="col-left">
                    <div id="admin-left">
                        ...
                        <h5 id="add" className='border-around pointer' onClick={(evnt) => showData(evnt)}><FontAwesomeIcon icon={faPlus} style={{ marginRight: '.5rem' }}></FontAwesomeIcon>Add Service</h5>
                        <h5 id="make" className='border-around pointer' onClick={(evnt) => showData(evnt)}><FontAwesomeIcon icon={faUserPlus} style={{ marginRight: '.5rem' }}></FontAwesomeIcon>Make Admin</h5>
                        <h5 id="manage" className='border-around pointer' onClick={(evnt) => showData(evnt)}><FontAwesomeIcon icon={faThLarge} style={{ marginRight: '.5rem' }}></FontAwesomeIcon>Manage Services</h5>
